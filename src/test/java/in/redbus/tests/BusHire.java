...
public class BusHire extends BaseTest {
	...
	@Test
	public void validOutstation() throws Throwable {

		String testName = "Outstation Valid";
	...
	@Test
	public void invalidOutstation() throws Throwable {

		String testName = "Outstation Invalid";
	...
	@Test
	public void validLocal() throws Throwable {

		String testName = "Local Valid";
		...
		bh.enterPickUpLocation(testData.get("Pickup"));
		log.info("Pickup location entered");
		extentTest.log(LogStatus.INFO, "Pickup location entered");

		bh.enterStartDateAndTime(testData.get("From Date and Time"));
		log.info("Start Date and Time entered");
		extentTest.log(LogStatus.INFO, "Start Date and Time entered");

		bh.numPassengers.sendKeys(testData.get("Num of passengers"));
		log.info("Number of passengers entered");
		extentTest.log(LogStatus.INFO, "Number of passengers entered");

		bh.proceedButtonLocal.click();
	...
	@Test
	public void invalidLocal() throws Throwable {

		String testName = "Local Invalid";
